 ...
 * @param data
 */
export function createProjectModule(data: CreateProjectModule, noErrMes: boolean = false) {
  return http.post<CreateProjectModuleData>(`/my/space/work_object/create`, data, { noErrMes })
}
 ...
 * @param data
 */
export function createProjectWork(data: CreateProjectWork, noErrMes: boolean = false) {
  return http.post(`/v2/my/space/work_item/create`, data, { noErrMes })
}
...
// 获取项目表格模块
export function getProjectTable(spaceId: string | number, conditionGroup: any, groups?: { field: string }[], sorts?: FilterSort[]) {
...
// 获取概览筛选组
export function getIntroConfig(obj: any) {
  return http.post<any>(`my/space/get_temp_config`, obj)
}

// 设置概览筛选组
export function setIntroConfig(obj: any) {
  return http.post<any>(`/my/space/set_temp_config`, obj)
}

export function delIntroConfig(obj: any) {
  return http.post<any>(`/my/space/del_temp_config`, obj)
}

// 获取概览响应
export function getIntroFilterCount(obj: any) {
  return http.post<any>(`v2/my/workbench/space/count2`, obj)
}

export function setProjectTempConfig(data: { spaceId: string, configs: any }) {
  return http.post(`/my/space/set_temp_config`, data)
}

export function getProjectTempConfig(data: { spaceId: string, keys: string[] }) {
  return http.post<any>(`/my/space/get_temp_config`, data)
}
