...
const noticeClass = computed(() => {
  return projectStore.isCollapse ? 'collapse' : 'expand'
})
...
const noticeTabs = computed(() => {
  return [
    ...
    },
    {
      ...
      text: '系统',
      count: 0,
      showRedIco: sysIndex.value > 0 && useNotice.showNotice,
    },
  ]
})
...
<template>
  <div class="notice-wrap" :class="noticeClass">
    <div class="header flex-row-between">
      ...
      <div class="tool flex-row-center">
        ...
        >
          ...
          <el-tooltip content="一键已读" placement="top" :offset="9" :disabled="!listData?.length">
        ...
        <div class="tool-close flex-center ml8" @click="closeNotice">
          <svg-icon name="notice-close" size="16" color="#999999" />
        </div>
      </div>
    </div>
    <!-- 内容 -->
