...
const menuArr = [
  ...
  },
  {
    title: 'BTable 表格',
    name: 'BTable',
    compontent: () => import(/* webpackChunkName: "dev" */'@/views/dev/data/BTableDemo.vue'),
  },
  {
    title: 'BDragLayout 拖放布局',
    name: 'BDragLayout',
    compontent: () => import(/* webpackChunkName: "dev" */'@/views/dev/data/BDragLayoutDemo.vue'),
  },
  ...
  },
  {
    title: 'BPopover 气泡卡片',
    name: 'BPopover',
    compontent: () => import(/* webpackChunkName: "dev" */'@/views/dev/feedback/BPopoverDemo.vue'),
  },
