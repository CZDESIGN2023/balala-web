...
<template>
  <a-tooltip title="复制任务ID、标题和链接">
    <div class="tool-box tool-link flex-row-center" @click="handleCopyLink">
      <SvgIcon name="link" color="#333333" size="16" />
    </div>
  </a-tooltip>
  <a-tooltip :title="followTooltipData.title">
    <div
      class="tool-box tool-follow flex-row-center"
  ...
  >
    <div class="tool-box tool-dropdown flex-row-center">
      <SvgIcon name="more" color="#333333" size="16" />
    ...
    <template #overlay>
      <div class="more">
        ...
        >
          <a-tooltip title="点击复制任务 ID" placement="left" :align="{ offset: [0, 0] }">
            <div
        ...
        <div v-if="dropDownData.isShow" class="ul pr8 pt8 pb8">
          <a-tooltip v-if="!state.workFlow.isLatestVersion" :title="dropDownData.isUpdate ? '点击将流程升级至最新' : '请联系项目管理员升级流程'" :align="{ offset: [0, 4] }">
            <div
