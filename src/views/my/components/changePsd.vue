  ...
  newPwd: [
    {
      required: true,
      validator: (rule, value, callback) =>
        verifyPassword(rule, value, callback, passwordForm.confirmPwd, true),
      trigger: 'blur',
    },
  ],
  confirmPwd: [
    {
      required: true,
      validator: (rule, value, callback) =>
        verifyPassword(rule, value, callback, passwordForm.newPwd, false),
      trigger: 'blur',
    },
  ],
})
    ...
    >
      <a-form-item name="pwd">
        <a-input-password
          ...
          @focus="passwordPlaceholder = '5 ～ 20个字符（支持英文/数字/符号）'"
      ...
      <a-form-item name="newPwd">
        <a-input-password
          ...
          @focus="npasswordPlaceholder = '5 ～ 20个字符（支持英文/数字/符号）'"
      ...
      <a-form-item name="confirmPwd">
        <a-input-password
          ...
          @focus="cpasswordPlaceholder = '5 ～ 20个字符（支持英文/数字/符号）'"
