...
<template>
  <div class="my-wrap">
    <div class="single-title-header flex-row-start flex-shrink-0">
      个人设置
    </div>
          ...
          <div class="module project-module">
            ...
            <div class="project-list mt4">
              <div v-for="item in projectList" :key="item" class="item mt12 flex-row-between">
                <p class="text14 icon-color flex-row-center mr24" style="max-width: 75%;" @click.stop="toProject(item.id)">
                  <!-- {{ item.spaceName }} -->
