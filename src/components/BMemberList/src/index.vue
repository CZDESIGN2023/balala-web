...
<template>
    ...
    <div :style="{ padding: wrapperPadding }">
      ...
      >
        <el-tooltip
          ...
          effect="dark"
          :teleported="false"
          :disabled="!item.disabled || !isTooltip"
          content="成员已添加"
          placement="top"
          :show-after="200"
        >
          <div class="info flex-one flex-row-start">
            ...
            >
              ...
              <b-head
                ...
                :src="item?.avatar || ''"
              />
              <p class="nickname text14 mr8 short-name">
                <b-ellipsis :content="item.userNickname" />
              </p>
  ...
  >
    <p v-if="removeItem.count" class="desc text14 icon-color mb16">
      移除成员需要把关联任务转移至指定成员
    </p>
    <BBaseSelect
