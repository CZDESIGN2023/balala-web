...
<template>
  <div class="b-input-priority flex" :class="className" :style="{ width }">
    <div class="select-box flex-row-between">
      <div>
        <div
          ...
          class="box flex-row-center text14 title-color pointer br4 w54 h24 pfm"
          :style="{ background: priorityItem.color }"
        >
          {{ priorityItem.label }}
        </div>
        <span v-else class="box flex-row-center text14 minor-color full-auto">{{
          placeholder
        }}</span>
      </div>
    </div>
    <b-select
      ...
      :list-height="className === 'detail table-style' ? 296 : 256"
    ...
    >
      ...
      <template #option="{ label, color }">
        <div class="priority-item priority-item-option">
          <div
            class="box flex-row-center text14 title-color br4 w54 h24 pfm"
